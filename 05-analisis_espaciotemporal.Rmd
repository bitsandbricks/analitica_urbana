...
```{r}
# Nos quedamos solo con los puntos ubicados en el hemisferio donde se ubica Buenos Aires
# (con eso eliminamos algunos puntos mal localizados)

delitos <- delitos %>% 
    filter(latitud <0, longitud <0)

# con la funcion make_bbox() generamos un rectángulo de coordenadas 
# que contiene todas las ubicaciones, que nos sirve para solicitar un mapa base
# en el próximo paso
...
**Descubriendo patrones temporales y espaciales en los datos**

I. Utilizar los tweets que se descargaron en el capítulo anterior o elegir algún dataset open data de la Ciudad que tenga tanto coordenadas como fecha. Quienes se animen pueden trabajar con ambos y luego compararlos entre sí.
