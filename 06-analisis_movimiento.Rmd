...
```{r}
estaciones <- read_csv("https://bitsandbricks.github.io/data/estaciones_BA_bici.csv")
...
I. Elegir alguna de las siguientes opciones:
...
II. Según la opción elegida en el punto I, resolver:
...
Consejos:
Si bajamos datos de OpenStreetMap -por ejemplo, escuelas de una ciudad- los obetenemos en formato `sf`.
Un dataframe `sf` tiene sus coordenadas en una sola columna, llamada "geometry". Pero que pasa si queremos los datos en dos columnas, lat y long, para aprovechar los ejemplos de funciones de ruteo que hemos visto? Muy simple.
